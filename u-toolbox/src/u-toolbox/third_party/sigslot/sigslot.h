...
protected:
        has_slots_interface(signal_connect_t conn, signal_disconnect_t disc,
            ...
            : m_signal_connect(conn), m_signal_disconnect(disc),
...
public:
        ...
        void disconnect_all()
        {
                ...
                while (!m_connected_slots.empty()) {
                        has_slots_interface *pdest =
                                m_connected_slots.front().getdest();
                ...
                while (it != itEnd) {
                        if (it->getdest() == pclass) {
                                ...
                                pclass->signal_disconnect(
                                        static_cast<_signal_base_interface *>(
                                                this));
                                return;
                        }
                        ++it;
                                      ...
                                      has_slots_interface *newtarget)
        {
                ...
                while (it != itEnd) {
                        if (it->getdest() == oldtarget) {
                                self->m_connected_slots.push_back(
                                        it->duplicate(newtarget));
                        }
...
public:
        ...
        void connect(desttype *pclass, void (desttype::*pmemfun)(Args...))
        {
                ...
                this->m_connected_slots.push_back(
                        _opaque_connection(pclass, pmemfun));
                pclass->signal_connect(
                        static_cast<_signal_base_interface *>(this));
        }
